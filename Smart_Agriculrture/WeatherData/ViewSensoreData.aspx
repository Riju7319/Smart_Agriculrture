...
<body>
    <form id="form1" runat="server" class="container py-4">
        ...
        <div class="d-flex justify-content-center align-items-center mb-3 gap-2">
            ...
            <button id="toggleAuto" class="btn btn-outline-secondary" type="button" onclick="toggleAuto()">
                Enable Auto Refresh
            </button>
        </div>
    ...
    <div class="col-md-3 col-6">
        ...
        <div class="card mb-4 p-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <h6 class="text-center text-secondary mb-2">🌡 Temperature Graph</h6>
                ...
                <div class="col-md-6">
                    <h6 class="text-center text-secondary mb-2">💧 Humidity Graph</h6>
                    <div class="chart-container">
                ...
                <div class="col-md-6">
                    <h6 class="text-center text-secondary mb-2">🌱 Soil Moisture Graph</h6>
                    <div class="chart-container">
                ...
                <div class="col-md-6">
                    <h6 class="text-center text-secondary mb-2">☀ Light Intensity Graph</h6>
                    <div class="chart-container">
    ...
    <script>
        ...
        function toggleAuto() {
            ...
            if (autoUpdate) {
                ...
                autoInterval = setInterval(() => fetchData(true), 30000);
            } else {
        ...
        async function fetchData(auto = false) {
            ...
            try {
                ...
                renderCharts(allData.slice(0, 15)); // Show latest 15 readings in graphs
        ...
        function updateCards(latest) {
            ...
            document.getElementById("soilVal").innerText =
                soil > 800 ? "Dry (Low Moisture)" : soil > 300 ? "Moist (Good)" : "Wet";

            document.getElementById("lightVal").innerText =
                light > 600 ? "Dark" : light > 300 ? "Normal Light" : "Bright";

            const gasAlert = document.getElementById("gasAlert");
            if (gas > 400) gasAlert.classList.remove("d-none");
            else gasAlert.classList.add("d-none");
        ...
        function renderTable(page = 1) {
            ...
            let filtered = allData.filter(f =>
                f.field1?.toLowerCase().includes(search) ||
                f.field2?.toLowerCase().includes(search)
            );
            ...
            document.getElementById("recordInfo").innerText = `Showing ${start + 1}-${Math.min(end, filtered.length)} of ${filtered.length}`;
        ...
        function onCardClick(sensorType) {
            // Mapping card names to their pages
            const pageMap = {
            ...
            // Get the page for the selected card
            ...
            if (targetPage) {
                ...
                alert("Page for " + sensorType + " not found!");
            }
        }
        // Chart references
        let tempChart, humidChart, soilChart, lightChart;
        ...
        function renderCharts(feeds) {
            ...
            // Helper: reusable chart function
            function makeChart(ctx, label, data, color) {
                ...
                ctx.chartInstance = new Chart(ctx, {
                    ...
                    options: {
                        ...
                        scales: {
                            x: { display: false },
                            y: { ticks: { color: '#6c757d' }, beginAtZero: true }
                        }
                    }
                });
            }
        ...
        function onStatusCardClick(type) {
            // Map the status cards to their corresponding pages
            const pageMap = {
                "Pump": "pumpdata.aspx",
                "Light": "lightcontroldata.aspx"
            };

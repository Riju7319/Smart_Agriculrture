<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pumpdata.aspx.cs" Inherits="Smart_Agriculrture.WeatherData.pumpdata" %>
...
<head runat="server">
    ...
    <title>💧 Pump Usage Analytics</title>
...
<form id="form1" runat="server" class="container py-4">
    <h3 class="text-center mb-4">💧 Pump Usage Analytics</h3>
    <!-- Usage Table -->
    <div class="card p-4 mt-4">
        <h5 class="text-center mb-3">📅 Daily Pump Usage (Hours)</h5>
    ...
    <div class="card p-3 mb-4 mt-4">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                <label class="form-label">Pump Wattage (W)</label>
                <input type="number" id="wattInput" class="form-control" value="500" />
            </div>
    ...
    <div class="card p-4 mb-4">
        <h5 class="text-center">Pump ON/OFF Timeline</h5>
...
<script>
    ...
    async function fetchAndAnalyze() {
        ...
        const watt = parseFloat($("#wattInput").val()) || 500;
        ...
        try {
            ...
            const timeline = feeds
                .filter(f => f.field6 !== null)
                .map(f => ({
                    time: new Date(f.created_at),
                    state: f.field6 === "1" ? 1 : 0
                }));

            if (timeline.length === 0) {
                $("#summaryText").html("⚠ No valid pump data found.");
                return;
            }
            ...
            renderPumpChart(timeline);
            renderUsageTable(dailyUsage);

            $("#summaryText").html(`
                ✅ <b>Total Pump Runtime:</b> ${totalHours} hours<br/>
    ...
    function renderPumpChart(timeline) {

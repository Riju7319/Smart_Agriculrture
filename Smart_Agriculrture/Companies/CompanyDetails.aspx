<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyDetails.aspx.cs"
    Inherits="Smart_Agriculrture.Companies.CompanyDetails" %>
        ...
        <form id="form1" runat="server">
            ...
            <div class="page-header">
                <div>
                    ...
                    <div class="subtitle">
                        <asp:Label ID="lblCompanySubtitle" runat="server" />
                    </div>
                </div>
                <div class="header-actions">
                    <a href="Companies.aspx" class="btn-hdr btn-back">← Back</a>
                    <asp:Button ID="btnExportExcel" runat="server" Text="📥 Export Excel" CssClass="btn-hdr btn-export"
                        OnClick="btnExportExcel_Click" CausesValidation="false" />
                </div>
            </div>
            ...
            <div class="content-area">
                ...
                <div class="metrics-bar">
                    <div class="metric-card">
                        ...
                        <div class="mc-value mc-income">₹
                            <asp:Label ID="lblTotalIncome" runat="server" Text="0" />
                        </div>
                    </div>
                    <div class="metric-card">
                        <div class="mc-label">Total Expenses</div>
                        <div class="mc-value mc-expense">₹
                            <asp:Label ID="lblTotalExpenses" runat="server" Text="0" />
                        </div>
                    </div>
                    <div class="metric-card">
                        <div class="mc-label">Net Balance</div>
                        <div class="mc-value mc-balance">₹
                            <asp:Label ID="lblNetBalance" runat="server" Text="0" />
                        </div>
                    </div>
                </div>
                ...
                <%--===============INVOICES TAB===============--%>
                    <div id="tab-invoices" class="tab-panel active">
                        <div class="action-bar">
                            <a href='<%# "CreateInvoice.aspx?CompanyID=" + hfCompanyID.Value %>' class="btn-add-sm"
                                id="lnkCreateInvoice">➕ Create Invoice</a>
                            <div class="filter-row">
                                <asp:TextBox ID="txtInvSearch" runat="server" placeholder="🔍 Search..."
                                    AutoPostBack="true" OnTextChanged="FilterInvoices" />
                                <asp:DropDownList ID="ddlPaymentStatus" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="FilterInvoices">
                        ...
                        <div class="data-table">
                            <asp:GridView ID="gvInvoices" runat="server" AutoGenerateColumns="false"
                                ...
                                OnPageIndexChanging="gvInvoices_PageIndexChanging" OnRowCommand="gvInvoices_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sent">
                                        <ItemTemplate>
                                            <span
                                                class='<%# Convert.ToBoolean(Eval("IsSent")) ? "badge-status badge-sent" : "badge-status badge-draft" %>'>
                                    ...
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <span
                                                class='<%# "badge-status badge-" + Eval("PaymentStatus").ToString().ToLower().Replace(" ","").Replace("partiallypaid","partial") %>'>
                                                <%# Eval("PaymentStatus") %>
                                            </span>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <a href='<%# "InvoiceView.aspx?InvoiceID=" + Eval("InvoiceID") %>'
                                                class="btn-sm-action">👁 View</a>
                                            <a href='<%# "CreateInvoice.aspx?CompanyID=" + Request.QueryString["CompanyID"] + "&edit=" + Eval("InvoiceID") %>'
                                                class="btn-sm-action">✏️ Edit</a>
                                            <asp:LinkButton ID="btnMarkPaid" runat="server" CommandName="MarkPaid"
                                                CommandArgument='<%# Eval("InvoiceID") %>'
                                                CssClass="btn-sm-action btn-paid" CausesValidation="false">✓ Paid
                                            </asp:LinkButton>
                                            <a href='<%# "CreateInvoice.aspx?CompanyID=" + Request.QueryString["CompanyID"] + "&clone=" + Eval("InvoiceID") %>'
                                                class="btn-sm-action">📋 Clone</a>
                                            <asp:LinkButton ID="btnDeleteInv" runat="server" CommandName="DeleteInv"
                                                CommandArgument='<%# Eval("InvoiceID") %>' CssClass="btn-sm-action"
                                                ForeColor="Red" OnClientClick="return confirm('Delete this invoice?');"
                    ...
                    <%--===============CUSTOMERS TAB===============--%>
                        <div id="tab-customers" class="tab-panel">
                            <div class="action-bar">
                                <button type="button" class="btn-add-sm" onclick="openCustomerModal()">➕ Add
                                    Customer</button>
                            </div>
                            <div class="data-table">
                                <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Actions">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnEditCust" runat="server" CommandName="EditCust"
                                                    CommandArgument='<%# Eval("CustomerID") %>' CssClass="btn-sm-action"
                                                    CausesValidation="false">✏️ Edit</asp:LinkButton>
                                                <asp:LinkButton ID="btnDeleteCust" runat="server"
                                                    CommandName="DeleteCust" CommandArgument='<%# Eval("CustomerID") %>'
                                                    CssClass="btn-sm-action" ForeColor="Red"
                        ...
                        <%--===============EXPENSES TAB===============--%>
                            <div id="tab-expenses" class="tab-panel">
                                <div class="action-bar">
                                    <button type="button" class="btn-add-sm" onclick="openExpenseModal()">➕ Add
                                        Expense</button>
                                </div>
                                <div class="data-table">
                                    <asp:GridView ID="gvExpenses" runat="server" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Actions">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnEditExp" runat="server" CommandName="EditExp"
                                                        CommandArgument='<%# Eval("ExpenseID") %>'
                                                        CssClass="btn-sm-action" CausesValidation="false">✏️ Edit
                                                    </asp:LinkButton>
                                                    <asp:LinkButton ID="btnDeleteExp" runat="server"
                                                        CommandName="DeleteExp"
                                                        CommandArgument='<%# Eval("ExpenseID") %>'
                                                        CssClass="btn-sm-action" ForeColor="Red"
                                                        OnClientClick="return confirm('Delete this expense?');"
                                                        CausesValidation="false">🗑 Delete</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                            ...
                            <%--===============NOTES TAB===============--%>
                                <div id="tab-notes" class="tab-panel">
                                    <div class="action-bar">
                                        <button type="button" class="btn-add-sm" onclick="openNoteModal()">➕ Add
                                            Note</button>
                                    </div>
                                                ...
                                                <div class="note-meta">
                                                    📅 <%# Eval("CreatedDate", "{0:dd MMM yyyy, hh:mm tt}" ) %> — <%#
                                                            ...
                                                            <div style="float:right;">
                                                                <asp:LinkButton ID="btnEditNote" runat="server"
                                                                    CommandName="EditNote"
                                                                    CommandArgument='<%# Eval("NoteID") %>'
                                                                    CssClass="btn-sm-action" CausesValidation="false">✏️
                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnDeleteNote" runat="server"
                                                                    CommandName="DeleteNote"
                                                                    CommandArgument='<%# Eval("NoteID") %>'
                                                                    CssClass="btn-sm-action" ForeColor="Red"
                                                                    OnClientClick="return confirm('Delete this note?');"
                                    ...
                                    <asp:Label ID="lblNoNotes" runat="server" Text="No notes yet." CssClass="text-muted"
                                        Visible="false" style="display:block;text-align:center;padding:40px;" />
                                </div>
                                ...
                                <%--===============COMPANY DETAILS TAB===============--%>
                                    <div id="tab-details" class="tab-panel">
                                        <div class="detail-form">
                                            ...
                                            <label>Address</label>
                                            <asp:TextBox ID="txtEditAddress" runat="server" TextMode="MultiLine"
                                                Rows="3" />
                                            <asp:Button ID="btnUpdateCompany" runat="server" Text="✏️ Update Details"
                                                CssClass="btn-update" OnClick="btnUpdateCompany_Click" />
                                        </div>

                                        <hr style="margin: 28px 0; border-color: #e5e7eb;" />

                                        <!-- Bank Accounts Section -->
                                        <h4 style="font-size:16px;font-weight:700;margin-bottom:14px;">🏦 Bank Accounts
                                        </h4>
                                        <div class="data-table" style="margin-bottom:20px;">
                                            <asp:GridView ID="gvBankAccounts" runat="server" AutoGenerateColumns="false"
                                                ...
                                                EmptyDataText="No bank accounts yet."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Default">
                                                        <ItemTemplate>
                                                            <span
                                                                class='<%# Convert.ToBoolean(Eval("IsDefault")) ? "badge-status badge-sent" : "" %>'>
                                                    ...
                                                    <asp:TemplateField HeaderText="Actions">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnEditBank" runat="server"
                                                                CommandName="EditBank"
                                                                CommandArgument='<%# Eval("BankAccountID") %>'
                                                                CssClass="btn-sm-action" CausesValidation="false">✏️
                                                                Edit</asp:LinkButton>
                                                            <asp:LinkButton ID="btnDeleteBank" runat="server"
                                        ...
                                        <div class="detail-form"
                                            style="background:#f8fafc;border:1.5px dashed #d1d5db;border-radius:12px;padding:20px;margin-top:8px;">
                                            <h5 style="font-size:14px;font-weight:600;margin-bottom:12px;">➕ Add/Edit
                                                Bank Account</h5>
                                            <asp:HiddenField ID="hfEditBankID" runat="server" />
                                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                                                <div>
                                                    <label>Account Name *</label>
                                                    <asp:TextBox ID="txtBankAccName" runat="server"
                                                        placeholder="e.g. Smart Agriculture" />
                                                </div>
                                                <div>
                                                    <label>Account Number *</label>
                                                    <asp:TextBox ID="txtBankAccNumber" runat="server"
                                                ...
                                                <div>
                                                    <label>UPI ID</label>
                                                    <asp:TextBox ID="txtBankUPI" runat="server"
                                                        placeholder="e.g. name@upi" />
                                                </div>
                                                <div>
                                                    <label>Bank Name</label>
                                                    <asp:TextBox ID="txtBankNameInput" runat="server"
                                                        placeholder="e.g. State Bank of India" />
                                                </div>
                                                <div>
                                                    <label>PAN Number</label>
                                                    <asp:TextBox ID="txtBankPAN" runat="server"
                                                        placeholder="e.g. ABCDE1234F" />
                                                </div>
                                                <div style="display:flex;align-items:flex-end;padding-bottom:4px;">
                                                    <asp:CheckBox ID="chkDefaultBank" runat="server"
                                                        Text=" Set as Default" />
                                                </div>
                                            </div>
                                            <asp:Button ID="btnSaveBankAccount" runat="server" Text="Save Bank Account"
                                                CssClass="btn-save" style="margin-top:12px;"
                                                OnClick="btnSaveBankAccount_Click" />
                                        </div>
                                    </div>
            </div>
            ...
            <%--===============ADD/EDIT EXPENSE MODAL===============--%>
                <div class="modal-overlay" id="expenseModal">
                    <div class="modal-box">
                        ...
                        <asp:TextBox ID="txtExpDesc" runat="server" TextMode="MultiLine" Rows="2"
                            placeholder="Brief description" />
                        <div class="modal-actions">
                            <button type="button" class="btn-cancel" onclick="closeExpenseModal()">Cancel</button>
                            <asp:Button ID="btnSaveExpense" runat="server" Text="Save Expense" CssClass="btn-save"
                                OnClick="btnSaveExpense_Click" />
                        </div>
                    </div>
                </div>
                ...
                <%--===============ADD/EDIT NOTE MODAL===============--%>
                    <div class="modal-overlay" id="noteModal">
                        <div class="modal-box">
                            ...
                            <label>Note *</label>
                            <asp:TextBox ID="txtNoteText" runat="server" TextMode="MultiLine" Rows="4"
                                placeholder="Write your note here..." />
                            <div class="modal-actions">
                                <button type="button" class="btn-cancel" onclick="closeNoteModal()">Cancel</button>
                                <asp:Button ID="btnSaveNote" runat="server" Text="Save Note" CssClass="btn-save"
                    ...
                    <%--===============ADD/EDIT CUSTOMER MODAL===============--%>
                        <div class="modal-overlay" id="customerModal">
                            <div class="modal-box">
                                ...
                                <label>Email</label>
                                <asp:TextBox ID="txtCustEmail" runat="server" TextMode="Email"
                                    placeholder="customer@example.com" />
                                <label>Phone</label>
                                <asp:TextBox ID="txtCustPhone" runat="server" placeholder="Phone number" />
                                <label>Address</label>
                                <asp:TextBox ID="txtCustAddress" runat="server" TextMode="MultiLine" Rows="2"
                                ...
                                <div class="modal-actions">
                                    ...
                                    <asp:Button ID="btnSaveCustomer" runat="server" Text="Save Customer"
                                        CssClass="btn-save" OnClick="btnSaveCustomer_Click" />
                                </div>
                            </div>
                        </div>
